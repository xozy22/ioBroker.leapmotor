...
const REMOTE_ACTION_SPECS = {
    ...
    [C.REMOTE_CTL_CHARGE_START]: { cmdId: '193', cmdContent: '{"value":"start"}' },
    [C.REMOTE_CTL_CHARGE_STOP]: { cmdId: '193', cmdContent: '{"value":"stop"}' },
    [C.REMOTE_CTL_SENTRY_MODE_ON]: { cmdId: '220', cmdContent: '{"value":"1"}' },
    [C.REMOTE_CTL_SENTRY_MODE_OFF]: { cmdId: '220', cmdContent: '{"value":"0"}' },
    [C.REMOTE_CTL_HEALTHY_CHARGING_ON]: { cmdId: '480', cmdContent: '{"value":"1"}' },
    [C.REMOTE_CTL_HEALTHY_CHARGING_OFF]: { cmdId: '480', cmdContent: '{"value":"0"}' },
    [C.REMOTE_CTL_ON3_ON]: { cmdId: '410', cmdContent: '{"on3":"on"}' },
    [C.REMOTE_CTL_ON3_OFF]: { cmdId: '410', cmdContent: '{"on3":"off"}' },
    [C.REMOTE_CTL_FUEL_HEATING_ON]: { cmdId: '380', cmdContent: '{"value":"1"}' },
    [C.REMOTE_CTL_FUEL_HEATING_OFF]: { cmdId: '380', cmdContent: '{"value":"0"}' },
    [C.REMOTE_CTL_SUNROOF_OPEN]: { cmdId: '300', cmdContent: '{"value":"open"}' },
    [C.REMOTE_CTL_SUNROOF_CLOSE]: { cmdId: '300', cmdContent: '{"value":"close"}' },
    [C.REMOTE_CTL_HOTSPOT]: { cmdId: '140', cmdContent: '{"value":"findCar"}' },
    [C.REMOTE_CTL_AUTOPARK]: { cmdId: '150', cmdContent: '{"value":"findCar"}' },
    [C.REMOTE_CTL_BLE_KEY_RESTART]: { cmdId: '430', cmdContent: '{"value":"restart"}' },
    [C.REMOTE_CTL_SPEED_LIMIT]: { cmdId: '510', cmdContent: '{"value":"80"}' },
    [C.REMOTE_CTL_MUSIC]: { cmdId: '270', cmdContent: '{"operation":"play"}' },
    [C.REMOTE_CTL_VIDEO]: { cmdId: '290', cmdContent: '{"operation":"play"}' },
};
